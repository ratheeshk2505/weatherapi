...
function displayValues(data){
        if(data.cod>399){
            disp.innerHTML=`<div class="text-center text-white p-1 mt-3 border border-secondary rounded-3 col-12" style="background-color: rgb(0, 0, 0)"><span class="fs-2">City Not Found.</span></div>`;
        }
        else{
        let mytz=19800;
        ...
        let html_data=`<div class="container-fluid">
                        <div class="row mt-3 border border-dark rounded-3 bg-light">
                            ...
                            <div class="col-sm-12 col-md-12 col-lg-4 p-3 mt-4 text-center"><img src="${icon_url}" width="100px"><span class="fs-2"> <b>${data.weather[0].main}</b></span><br><span class="ms-5 fs-6 fst-italic">  ${data.weather[0].description}</span></div>
